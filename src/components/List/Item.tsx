 ...
 */
  ...
  return (
    <div className={cn('col-6 col-lg-4 ', styles.itemWrapper)}>
    ...
    {/*       <h2>{image.strMeal}</h2> */}
        ...
        <div className={styles.bodyWrapper}>
          <div className={cn(styles.actions,{[styles.hover] : isHoverCard})}>
            <div className={cn(styles.action, styles.edit)} onClick={() => clickEdit(recipe)}>
            ...
            <hr/>
            <div className={cn(styles.action, styles.delete)} onClick={() => clickDelete(recipe._id)}>
          ...
          <div className={styles.body}>
            <div className={styles.name}><h1>{recipe.name}</h1></div>
            <div className={styles.description}><p>{recipe.description}</p></div>
          </div>
         </div>
      </div>
    </div>
