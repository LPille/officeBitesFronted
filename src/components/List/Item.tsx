 ...
 */
  ...
  const { deleteRecipe, editingRecipe, setEditingRecipe} = useRecipe()
      ...
      <div className="item"         
        ...
        <div className="body-wrapper">
          <div className={cn('actions',{'hover' : isHoverCard})}>
            <div className="action edit" onClick={() => handleEdit(recipe)}>
            ...
            <hr/>
            <div className="action delete" onClick={() => handleDelete(recipe.id)}>
